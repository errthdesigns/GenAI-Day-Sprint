import svgPaths from "./svg-b7bijdo8zg";
...
export default function Miip() {
  return (
    <div className="bg-neutral-300 relative size-full" data-name="MIIP 104">
      <WhiteStrokeDefault />
      <WhiteStrokeDefault1 />
      <WhiteStrokeDefault2 />
      ...
      <WhiteStrokeDefault3 />
      <Group />
      <p className="absolute font-['Helvetica_Neue:Medium',sans-serif] leading-[36px] left-[108px] not-italic text-[64px] text-[rgba(0,0,213,0.15)] top-[494px] tracking-[-2.5px] w-[911px]">
        <span className="text-[#0000d5]">Erin, Vi</span>ur Names
      </p>
    </div>
  );
}