import svgPaths from "./svg-hst02cox3i";
...
export default function Miip() {
  return (
    <div className="bg-neutral-300 relative size-full" data-name="MIIP 51">
      <WhiteStrokeDefault />
      <div className="absolute font-['Droid_Sans:Regular',sans-serif] h-[468px] leading-[90px] left-[108px] not-italic text-[#0000d4] text-[64px] top-[278px] w-[911px]">
        <p className="mb-0">Must include the hero image​.</p>
        <p className="mb-0">Video needs to be 8 seconds​.</p>
