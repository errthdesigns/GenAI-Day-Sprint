import svgPaths from "./svg-io066ysuma";
...
function WhiteStrokeDefault() {
  return (
    <div className="absolute inset-[85.06%_80%_10.06%_11.46%]" data-name="White Stroke / Default">
...
function WhiteStrokeDefault1() {
  return (
    <div className="absolute inset-[85.06%_45.76%_10.06%_45.69%]" data-name="White Stroke / Default">
      <div className="absolute inset-0 rounded-[100px]" data-name=".atom Background">
        <div aria-hidden="true" className="absolute border-2 border-[#0000d5] border-solid inset-[-1px] pointer-events-none rounded-[101px]" />
      </div>
...
function WhiteStrokeDefault2() {
  return (
    <div className="absolute inset-[85.06%_11.53%_10.06%_79.93%]" data-name="White Stroke / Default">
      <div className="absolute inset-0 rounded-[100px]" data-name=".atom Background">
        <div aria-hidden="true" className="absolute border-2 border-[#0000d5] border-solid inset-[-1px] pointer-events-none rounded-[101px]" />
      </div>
...
function WhiteStrokeDefault3() {
  return (
    <div className="absolute inset-[10.06%_83.96%_85.06%_7.5%]" data-name="White Stroke / Default">
      <p className="absolute bottom-[30%] font-['Droid_Sans:Bold',sans-serif] leading-[20px] left-0 not-italic right-0 text-[#0000d5] text-[14px] text-center top-[30%]">Droga5 AI Day</p>
    </div>
  );
}
...
export default function Miip() {
  return (
    <div className="bg-neutral-300 relative size-full" data-name="MIIP 35">
      <FilterPart />
      <WhiteStrokeDefault />
      <WhiteStrokeDefault1 />
      <WhiteStrokeDefault2 />
