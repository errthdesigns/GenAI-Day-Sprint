import svgPaths from "./svg-9pd6sfqm2d";
...
function FilterPart() {
  return (
    <div className="absolute contents left-[533px] top-[322px]" data-name="filter-part">
      <Group1 />
      <p className="absolute font-['Droid_Sans:Bold',sans-serif] h-[163px] leading-[163.18px] left-[717px] not-italic text-[#0000d5] text-[163.18px] text-center top-[423px] translate-x-[-50%] w-[260px]">0</p>
...
export default function Timer() {
  return (
    <div className="bg-neutral-300 relative size-full" data-name="Timer">
      <FilterPart />
      <WhiteStrokeDefault />
      <WhiteStrokeDefault1 />
      <WhiteStrokeDefault2 />
