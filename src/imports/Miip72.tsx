import svgPaths from "./svg-3f6vt9me6g";
...
export default function Miip() {
  return (
    <div className="bg-neutral-300 relative size-full" data-name="MIIP 72">
      ...
      <WhiteStrokeDefault />
      <div className="absolute font-['Droid_Sans:Regular',sans-serif] h-[445px] leading-[60px] left-[108px] not-italic text-[#0000d4] text-[50px] top-[calc(50%-223px)] w-[755px]">
        <p className="mb-0">{`Yey!​ `}</p>
        <p className="mb-0">&nbsp;</p>
        <p className="mb-0">The client loves your idea!</p>
        <p className="mb-0">&nbsp;</p>
        <p>{`They love it so much that they want a key visual for Easter, Valentines' day, and Ramadan!`}</p>
      </div>
      <WhiteStrokeDefault1 />
