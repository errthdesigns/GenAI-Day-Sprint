...
export default function Miip() {
  return (
    <div className="bg-neutral-300 relative size-full" data-name="MIIP 38">
      <div className="absolute font-['Droid_Sans:Regular',sans-serif] h-[299px] leading-[90px] left-[calc(50%-623px)] not-italic text-[#0000d4] text-[64px] top-[calc(50%-149px)] w-[1247px]">
