import svgPaths from "./svg-x5x1e7b0a8";
...
export default function Miip() {
  return (
    <div className="bg-neutral-300 relative size-full" data-name="MIIP 84">
      ...
      <WhiteStrokeDefault />
      <div className="absolute font-['Droid_Sans:Regular',sans-serif] h-[445px] leading-[60px] left-[108px] not-italic text-[#0000d4] text-[50px] top-[calc(50%-223px)] w-[728px]">
        <p className="mb-0">Oh no!​</p>
        <p className="mb-0">&nbsp;</p>
        <p className="mb-0">{`The client made a spelling error... It was actually ​for Halloween!​ `}</p>
        <p className="mb-0">&nbsp;</p>
        <p>Please update your asset​s.</p>
      </div>
