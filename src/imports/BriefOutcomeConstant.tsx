import svgPaths from "./svg-lrzxp27cqg";
...
export default function BriefOutcomeConstant() {
  return (
    <div className="bg-neutral-300 relative size-full" data-name="BRIEF.Outcome.Constant">
      <WhiteStrokeDefault />
      <div className="absolute font-['Droid_Sans:Regular',sans-serif] h-[468px] leading-[60px] left-[108px] not-italic text-[#0000d4] text-[50px] top-[278px] w-[911px]">
        <p className="font-['Droid_Sans:Bold',sans-serif] mb-0">Outcome:</p>
        <p className="mb-0">&nbsp;</p>
        <p className="mb-0">You must do what is asked in the brief.</p>
        <p className="mb-0">{`Uploaded files can be video, image, pdf or mp3. `}</p>
        <p className="mb-0">You have 10 mins.</p>
        <p className="mb-0">&nbsp;</p>
        <p className="mb-0">The fastest and best wins...</p>
        <p>&nbsp;</p>
      </div>
      ...
      <div className="absolute left-[1198px] size-[76.178px] top-[476px]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 77 77">
          <circle cx="38.0888" cy="38.0888" id="Ellipse 66" r="36.8052" stroke="var(--stroke-0, #979797)" strokeWidth="2.56708" />
        </svg>
      </div>
