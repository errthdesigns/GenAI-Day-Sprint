import svgPaths from "./svg-teaq53da8m";
...
export default function Miip() {
  return (
    <div className="bg-neutral-300 relative size-full" data-name="MIIP 77">
      ...
      <WhiteStrokeDefault />
      <div className="absolute font-['Droid_Sans:Regular',sans-serif] h-[540px] leading-[60px] left-[109px] not-italic text-[#0000d4] text-[50px] top-[calc(50%-287px)] w-[755px]">
        <p className="mb-0">{`Yey!​ `}</p>
        <p className="mb-0">&nbsp;</p>
        <p className="mb-0">{`The client loves your idea!​ `}</p>
        <p className="mb-0">&nbsp;</p>
        <p className="mb-0">{`They want you to make a 30” ​ad that expands on the idea.​ `}</p>
        <p className="mb-0">&nbsp;</p>
        <p>Please storyboard it ​so they can approve!​</p>
      </div>
      <WhiteStrokeDefault1 />
