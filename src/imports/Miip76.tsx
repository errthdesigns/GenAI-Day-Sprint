import svgPaths from "./svg-4yu5iqt7tk";
...
export default function Miip() {
  return (
    <div className="bg-neutral-300 relative size-full" data-name="MIIP 76">
      <div className="absolute flex h-[calc(1px*((var(--transform-inner-width)*0.7071067690849304)+(var(--transform-inner-height)*0.7071067690849304)))] items-center justify-center left-[1346.92px] top-[24.38px] w-[calc(1px*((var(--transform-inner-height)*0.7071067690849304)+(var(--transform-inner-width)*0.7071067690849304)))]" style={{ "--transform-inner-width": "45", "--transform-inner-height": "45" } as React.CSSProperties}>
        <div className="flex-none rotate-[315deg]">
          <AddRoundLight />
        </div>
      </div>
      <WhiteStrokeDefault />
      <div className="absolute font-['Droid_Sans:Regular',sans-serif] h-[480px] leading-[60px] left-[109px] not-italic text-[#0000d4] text-[50px] top-[calc(50%-240px)] w-[755px]">
        <p className="mb-0">{`Yey!​ `}</p>
        <p className="mb-0">&nbsp;</p>
        <p className="mb-0">{`The client loves your idea!​ `}</p>
        <p className="mb-0">&nbsp;</p>
        <p className="mb-0">But they need a 3 page strategic sell in for board.​</p>
        <p className="mb-0">&nbsp;</p>
        <p>Please make a deck.​</p>
      </div>
      <WhiteStrokeDefault1 />
