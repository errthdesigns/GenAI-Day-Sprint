import svgPaths from "./svg-ituqk6zkp2";
    ...
    <div className="absolute contents left-[1196px] top-[474px]">
      <div className="absolute left-[1196px] size-[76.178px] top-[474px]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 77 77">
          <circle cx="38.0888" cy="38.0888" fill="var(--fill-0, #D4D4D4)" id="Ellipse 68" r="36.8052" stroke="var(--stroke-0, #0000D5)" strokeWidth="2.56708" />
        </svg>
      </div>
          ...
          <div className="relative size-full">
            <div className="absolute inset-[-3.33%_-8.56%_-3.07%_-3.7%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 30 37">
                <path d={svgPaths.p1e11f600} id="Line 2" stroke="var(--stroke-0, #0000D5)" strokeWidth="3" />
              </svg>
            </div>
          </div>
        </div>
...
export default function Miip() {
  return (
    <div className="bg-neutral-300 relative size-full" data-name="MIIP 102">
      <WhiteStrokeDefault />
      <WhiteStrokeDefault1 />
      <WhiteStrokeDefault2 />
      ...
      <WhiteStrokeDefault3 />
      <Group />
      <p className="absolute font-['Helvetica_Neue:Medium',sans-serif] leading-[36px] left-[108px] not-italic text-[64px] text-[rgba(0,0,213,0.15)] top-[494px] tracking-[-2.5px] w-[911px]">Enter Your Names</p>
    </div>
  );
}